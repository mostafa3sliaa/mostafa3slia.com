...
export function GlassCard({ children, className, glow = true, ...props }: GlassCardProps) {
  return (
    <motion.div
      ...
      className={cn(
        "group relative overflow-hidden rounded-[8px] border border-white/12 bg-[#0d0d0d] md:bg-white/[0.055] p-6 max-md:shadow-none shadow-2xl shadow-black/25 max-md:backdrop-filter-none backdrop-blur-2xl",
